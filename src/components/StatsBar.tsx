          ...
          {stats.map((s, i) => (
            <div
              ...
              className={
                ...
                (i > 0
                  ? "md:before:content-[''] md:before:absolute md:before:left-0 md:before:top-1/2 md:before:-translate-y-1/2 md:before:h-10 md:before:w-px md:before:bg-primary/70"
                  : "")
              }
            >
